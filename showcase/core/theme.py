...
def apply_theme() -> None:
    st.markdown(
        ...
        [data-testid="stSidebarNavLink"] {color: var(--ink) !important; -webkit-text-fill-color:var(--ink) !important;}
        [data-testid="stPageLink-NavLink"] {color: var(--ink) !important; -webkit-text-fill-color:var(--ink) !important;}
